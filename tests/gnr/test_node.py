...
class TestParseConnect(unittest.TestCase):
    ...
    def test_parse_connect_ip6(self):
        addr = parse_connect("10.30.12.13:45,[::ffff:0:0:0]:96,10.30.10.12:3013,"
