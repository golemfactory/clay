...
@mock.patch('golem.ranking.manager.databasemanager.get_provider_efficiency', mock.Mock())
@mock.patch('golem.ranking.manager.databasemanager.get_provider_efficacy', mock.Mock())
@mock.patch(
