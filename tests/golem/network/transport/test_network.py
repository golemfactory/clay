...
class TestNetwork(TestWithReactor):
    ...
    def test(self):
        ...
        connect_info = TCPConnectInfo(protocol_id=1,
                                      socket_addresses=[address],
                                      established_callback=_conn_success(0),
                                      failure_callback=_conn_failure(0))
        self.connect_success = None
        ...
        connect_info_2 = TCPConnectInfo(protocol_id=1,
                                        socket_addresses=[address2],
                                        established_callback=_conn_success(1),
                                        failure_callback=_conn_failure(1))
        self.connect_success = None
        ...
        connect_info_3 = TCPConnectInfo(protocol_id=1,
                                        socket_addresses=[address, address2],
                                        established_callback=_conn_success(2),
                                        failure_callback=_conn_failure(2))
        self.connect_success = None
