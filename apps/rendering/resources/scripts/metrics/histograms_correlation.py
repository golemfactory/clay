...
class MetricHistogramsCorrelation:
    ...
    def calculate_normalized_histogram(image):
        ...
        histogram = cv2.calcHist([image], range(channels_number), None,
    ...
    @classmethod
    def compare_histograms(cls, image_a, image_b):
        histogram_a = cls.calculate_normalized_histogram(image_a)
        histogram_b = cls.calculate_normalized_histogram(image_b)
