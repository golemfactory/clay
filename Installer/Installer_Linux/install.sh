...
declare -r ipfs_url='https://dist.ipfs.io/go-ipfs/v0.4.4/'
declare -r ipfs_package='go-ipfs_v0.4.4_linux-amd64.tar.gz'
...
function get_golem_version()
{
    ...
    if [[ $newest_version -le $installed_version ]]; then     # @todo need to be upgraded in versioning
