...
class TaskSession(MiddlemanSafeSession):
    ...
    def request_resource(self, task_id, resource_header):
        ...
        :return:
        """
        self.send(MessageGetResource(task_id, cbor.dumps(resource_header)))
    ...
    def __send_delta_resource(self, msg):
        res_file_path = self.task_manager.get_resources(msg.task_id, cbor.loads(msg.resource_header),
                                                        resource_types["zip"])
    ...
    def __send_resource_parts_list(self, msg):
        res = self.task_manager.get_resources(msg.task_id, cbor.loads(msg.resource_header),
