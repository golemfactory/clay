...
from golem.marketplace import (
    DEFAULT_REQUESTOR_MARKET_STRATEGY, RequestorMarketStrategy)
...
class TaskManager(TaskEventListener):
    ...
    def get_requestor_market_strategy_for_task(
        ...
        try:
            market_strategy =\
                self.task_types[task.task_definition.task_type.lower()]\
                    .REQUESTOR_MARKET_STRATEGY
        except KeyError:
            pass
