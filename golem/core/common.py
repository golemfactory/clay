...
def get_golem_path():
    ...
    """
    golem_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../"))
    if golem_path.endswith('golem') or golem_path.endswith('golem/'):
        return golem_path
    return os.path.join(golem_path, 'golem')
