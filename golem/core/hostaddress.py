...
def get_external_address(source_port=0):
    """ Method tries to get host public address with STUN protocol
    :param int source_port: port that should be used for connection.
    If 0, a free port will be picked by OS.
    :return (str, int): tuple with host public address and public port that is
    mapped to local <source_port>
    """
