...
def format_3ds_max_cmd_with_frames(cmd_file, frames, output_file, outfilebasename, scenefile, width, height,
                                   preset_file):
    cmd = '{} -outputName:{}\\{}.exr -frames:{} "{}" -rfw:0 -width={} -height={} -rps:"{}"'.format(cmd_file,
                                                                                                   output_file,
                                                                                                   outfilebasename,
                                                                                                   frames, scenefile,
                                                                                                   width, height,
