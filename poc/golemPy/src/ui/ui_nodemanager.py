...
class Ui_NodesManagerWidget(object):
    def setupUi(self, NodesManagerWidget):
        ...
        self.totalTasks = QtGui.QLineEdit(self.frameDetailedNode)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.totalChunksCalculatedInput = QtGui.QLineEdit(self.frameDetailedNode)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_4 = QtGui.QFrame(self.frameDetailedNode)
        ...
        self.horizontalLayout_4.addWidget(self.frameDetailedNode)
