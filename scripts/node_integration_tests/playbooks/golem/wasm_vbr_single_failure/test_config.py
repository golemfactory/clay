...
class TestConfig(TestConfigBase):
    def __init__(self, *, task_settings: str = 'WASM_g_flite') -> None:
        ...
        self.nodes[NodeId.provider3] = make_node_config_from_env(NodeId.provider3.value, 3)
        self.nodes[NodeId.provider4] = make_node_config_from_env(NodeId.provider4.value, 4)
