...
def main():
    ...
    msg.result_hash = 'sha1:{}'.format(
        hashlib.sha1('Gruba warstwa próchnicy świadczy o długiej działalności organicznej. Panami rzeki są krokodyle i lwy, po lasach krążą bez obawy jaguary, pekari, tapiry i małpy. Jest to ich dziedzictwo.'.encode('utf-8','replace')).hexdigest(),
    )
